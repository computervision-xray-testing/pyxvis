...
def plot_ROC(fpr, tpr, label='ROC', auc=0, seq=None):
    ...
    Args:
        ...
        auc (float): area under the curve index
        seq (list): controls when to show the ROC curve
...
def plot_precision_recall(precision, recall, label='precision/recall', ap=0, seq=None):
    """
